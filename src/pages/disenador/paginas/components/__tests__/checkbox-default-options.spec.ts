...
describe('Checkbox - Opciones por defecto', () => {
  ...
  it('Deveria crear checkbox con 2 opciones por defecto al arrastrarlo desde la paleta', () => {
  ...
  it('Deveria mantener opciones por defecto consistentes con select y radio', () => {
    const store = useDesignerStore()
  ...
  it('Deveria permitir modificar las opciones después de crear el checkbox', () => {
    const store = useDesignerStore()
